...
namespace ALittle
{
    public class ABnfFactory : IDisposable
    {
        ...
        public IVsEditorAdaptersFactoryService GetAdaptersFactory()
        {
            return m_adapters_factory;
        }

        public IVsUIShellOpenDocument GetOpenDocument()
        {
